  ...
  return (
    <PageShell>
      ...
      <p className="mt-3 text-ink-soft leading-relaxed">
        Organizujemo rođendane, krštenja i sva porodična okupljanja — pravi smo
        restoran za veliko društvo. Meni pravimo po dogovoru — od predjela i
        čorbi do pečenja i domaćih dezerata, po principu „kao kod kuće, samo
        bez posla u kuhinji“.
      </p>
